...
`claude`, [`uv`](https://github.com/astral-sh/uv), [`icuvisor`](https://github.com/ricardocabral/icuvisor), [`trainer-day-to-garmin`](https://github.com/j4shu/trainerday-to-garmin), Telegram
